...
module sopc_2_mm_interconnect_0 (
		...
		output wire [1:0]  motor1_s1_address,                       //                       motor1_s1.address
		output wire        motor1_s1_write,                         //                                .write
		input  wire [31:0] motor1_s1_readdata,                      //                                .readdata
		output wire [31:0] motor1_s1_writedata,                     //                                .writedata
		output wire        motor1_s1_chipselect,                    //                                .chipselect
	...
	wire  [31:0] motor1_s1_agent_m0_readdata;                                               // motor1_s1_translator:uav_readdata -> motor1_s1_agent:m0_readdata
	wire         motor1_s1_agent_m0_waitrequest;                                            // motor1_s1_translator:uav_waitrequest -> motor1_s1_agent:m0_waitrequest
	wire         motor1_s1_agent_m0_debugaccess;                                            // motor1_s1_agent:m0_debugaccess -> motor1_s1_translator:uav_debugaccess
	wire  [17:0] motor1_s1_agent_m0_address;                                                // motor1_s1_agent:m0_address -> motor1_s1_translator:uav_address
	wire   [3:0] motor1_s1_agent_m0_byteenable;                                             // motor1_s1_agent:m0_byteenable -> motor1_s1_translator:uav_byteenable
	wire         motor1_s1_agent_m0_read;                                                   // motor1_s1_agent:m0_read -> motor1_s1_translator:uav_read
	wire         motor1_s1_agent_m0_readdatavalid;                                          // motor1_s1_translator:uav_readdatavalid -> motor1_s1_agent:m0_readdatavalid
	wire         motor1_s1_agent_m0_lock;                                                   // motor1_s1_agent:m0_lock -> motor1_s1_translator:uav_lock
	wire  [31:0] motor1_s1_agent_m0_writedata;                                              // motor1_s1_agent:m0_writedata -> motor1_s1_translator:uav_writedata
	wire         motor1_s1_agent_m0_write;                                                  // motor1_s1_agent:m0_write -> motor1_s1_translator:uav_write
	wire   [2:0] motor1_s1_agent_m0_burstcount;                                             // motor1_s1_agent:m0_burstcount -> motor1_s1_translator:uav_burstcount
	wire         motor1_s1_agent_rf_source_valid;                                           // motor1_s1_agent:rf_source_valid -> motor1_s1_agent_rsp_fifo:in_valid
	wire  [98:0] motor1_s1_agent_rf_source_data;                                            // motor1_s1_agent:rf_source_data -> motor1_s1_agent_rsp_fifo:in_data
	wire         motor1_s1_agent_rf_source_ready;                                           // motor1_s1_agent_rsp_fifo:in_ready -> motor1_s1_agent:rf_source_ready
	wire         motor1_s1_agent_rf_source_startofpacket;                                   // motor1_s1_agent:rf_source_startofpacket -> motor1_s1_agent_rsp_fifo:in_startofpacket
	wire         motor1_s1_agent_rf_source_endofpacket;                                     // motor1_s1_agent:rf_source_endofpacket -> motor1_s1_agent_rsp_fifo:in_endofpacket
	wire         motor1_s1_agent_rsp_fifo_out_valid;                                        // motor1_s1_agent_rsp_fifo:out_valid -> motor1_s1_agent:rf_sink_valid
	wire  [98:0] motor1_s1_agent_rsp_fifo_out_data;                                         // motor1_s1_agent_rsp_fifo:out_data -> motor1_s1_agent:rf_sink_data
	wire         motor1_s1_agent_rsp_fifo_out_ready;                                        // motor1_s1_agent:rf_sink_ready -> motor1_s1_agent_rsp_fifo:out_ready
	wire         motor1_s1_agent_rsp_fifo_out_startofpacket;                                // motor1_s1_agent_rsp_fifo:out_startofpacket -> motor1_s1_agent:rf_sink_startofpacket
	wire         motor1_s1_agent_rsp_fifo_out_endofpacket;                                  // motor1_s1_agent_rsp_fifo:out_endofpacket -> motor1_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_021_src_valid;                                                     // cmd_mux_021:src_valid -> motor1_s1_agent:cp_valid
	wire  [97:0] cmd_mux_021_src_data;                                                      // cmd_mux_021:src_data -> motor1_s1_agent:cp_data
	wire         cmd_mux_021_src_ready;                                                     // motor1_s1_agent:cp_ready -> cmd_mux_021:src_ready
	wire  [25:0] cmd_mux_021_src_channel;                                                   // cmd_mux_021:src_channel -> motor1_s1_agent:cp_channel
	wire         cmd_mux_021_src_startofpacket;                                             // cmd_mux_021:src_startofpacket -> motor1_s1_agent:cp_startofpacket
	wire         cmd_mux_021_src_endofpacket;                                               // cmd_mux_021:src_endofpacket -> motor1_s1_agent:cp_endofpacket
	...
	wire         motor1_s1_agent_rp_valid;                                                  // motor1_s1_agent:rp_valid -> router_023:sink_valid
	wire  [97:0] motor1_s1_agent_rp_data;                                                   // motor1_s1_agent:rp_data -> router_023:sink_data
	wire         motor1_s1_agent_rp_ready;                                                  // router_023:sink_ready -> motor1_s1_agent:rp_ready
	wire         motor1_s1_agent_rp_startofpacket;                                          // motor1_s1_agent:rp_startofpacket -> router_023:sink_startofpacket
	wire         motor1_s1_agent_rp_endofpacket;                                            // motor1_s1_agent:rp_endofpacket -> router_023:sink_endofpacket
	...
	wire         motor1_s1_agent_rdata_fifo_src_valid;                                      // motor1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_021:in_0_valid
	wire  [33:0] motor1_s1_agent_rdata_fifo_src_data;                                       // motor1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_021:in_0_data
	wire         motor1_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_021:in_0_ready -> motor1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_021_out_0_valid;                                         // avalon_st_adapter_021:out_0_valid -> motor1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_021_out_0_data;                                          // avalon_st_adapter_021:out_0_data -> motor1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_021_out_0_ready;                                         // motor1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_021:out_0_ready
	wire   [0:0] avalon_st_adapter_021_out_0_error;                                         // avalon_st_adapter_021:out_0_error -> motor1_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                           //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (motor1_s1_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (motor1_s1_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (motor1_s1_agent_m0_read),               //                         .read
		.uav_write              (motor1_s1_agent_m0_write),              //                         .write
		.uav_waitrequest        (motor1_s1_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (motor1_s1_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (motor1_s1_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (motor1_s1_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (motor1_s1_agent_m0_writedata),          //                         .writedata
		.uav_lock               (motor1_s1_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (motor1_s1_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (motor1_s1_address),                     //      avalon_anti_slave_0.address
		.av_write               (motor1_s1_write),                       //                         .write
		.av_readdata            (motor1_s1_readdata),                    //                         .readdata
		.av_writedata           (motor1_s1_writedata),                   //                         .writedata
		.av_chipselect          (motor1_s1_chipselect),                  //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (motor1_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (motor1_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (motor1_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (motor1_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (motor1_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (motor1_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (motor1_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (motor1_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (motor1_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (motor1_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (motor1_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (motor1_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (motor1_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (motor1_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (motor1_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (motor1_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (motor1_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (motor1_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (motor1_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (motor1_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (motor1_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (motor1_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (motor1_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (motor1_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (motor1_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (motor1_s1_agent_rf_source_data),             //                .data
		...
		.rdata_fifo_src_ready    (motor1_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (motor1_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (motor1_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) motor1_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (motor1_s1_agent_rf_source_data),             //        in.data
		.in_valid          (motor1_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (motor1_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (motor1_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (motor1_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (motor1_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (motor1_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (motor1_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (motor1_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (motor1_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	sopc_2_mm_interconnect_0_router_006 router_023 (
		.sink_ready         (motor1_s1_agent_rp_ready),              //      sink.ready
		.sink_valid         (motor1_s1_agent_rp_valid),              //          .valid
		.sink_data          (motor1_s1_agent_rp_data),               //          .data
		.sink_startofpacket (motor1_s1_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (motor1_s1_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sopc_2_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (motor1_s1_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (motor1_s1_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (motor1_s1_agent_rdata_fifo_src_ready),  //         .ready
