 ...
 *
 *	Este programa ajusta e mantém a informação de hora no sistema,
 *	utilizando o sysclock_timer. Na partida, o programa ajusta a hora
 *	a partir de um valor inicial contido no próprio código. A seguir,
 *	o sistema entra em um loop de verificação do teclado. Quando alguma
 *	tecla é digitada (seguida de <ENTER>, a hora certa é calculada e
 *	informada.
 *
 *
