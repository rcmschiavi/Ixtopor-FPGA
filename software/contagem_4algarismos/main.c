 ...
 * 			A contagem é exibida também, no formato hexadecimal, no console
 * 			do sistema NIOS II.
 *
  ============================================================================
 */
...
/*******************************************************************************/
// Define as portas para saída dos algarismos..
...
unsigned int contagem = 0; //  Variável para um algarismo...
unsigned int  retardo;		//  Variável para retardo entre incrementos...
 ...
 * hexadecimal... A contagem é exibida no console e nos mostradores de
...
int main (void)
{
	...
	while (1)  {
		...
		// Incrementa a contagem, até 9999, e então a reinicia...
		contagem++;
...
/*******************************************************************************
 *    Função para exibição de valor de quatro algarismos, sem sinal..
 *
 */
void atualiza_display ( unsigned int valor)  {
